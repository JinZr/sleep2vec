...
- `hparam-select` uses the metric and direction frozen in the recipe, preserves runs from earlier plans for the same step, reranks the complete step, and writes `reports/ranking.csv`.
