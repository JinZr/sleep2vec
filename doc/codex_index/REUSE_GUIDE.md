...
- Put config-independent effective-input checks in the task adapter, after decision materialization; reuse existing domain validators rather than duplicating schema rules.
