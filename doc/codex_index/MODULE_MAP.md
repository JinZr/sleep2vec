...
| Agent control plane | [`agent_tools/`](../../agent_tools/), [`agent_tools/ARCHITECTURE.md`](../../agent_tools/ARCHITECTURE.md) | Consultation, context, plans, managed experiments, append-only research logs, hparam lifecycle, progress, summaries | agent-facing contracts or experiment ownership changes |
