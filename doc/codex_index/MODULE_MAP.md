...
| Managed evaluation pipeline | [`agent_tools/experiment_pipeline.py`](../../agent_tools/experiment_pipeline.py), [`agent_tools/experiment_pipeline_cohort_selection.py`](../../agent_tools/experiment_pipeline_cohort_selection.py), [`agent_tools/experiment_pipeline_results.py`](../../agent_tools/experiment_pipeline_results.py), [`agent_tools/experiments.py`](../../agent_tools/experiments.py) | Wait for managed sources, freeze ranked checkpoints or candidates, run external matrices or internal selection gates followed by winner-only reporting, validate results, and finalize | `experiment-run`, external-matrix, cohort-selection, retry, result validation, or pipeline-resume behavior changes |
