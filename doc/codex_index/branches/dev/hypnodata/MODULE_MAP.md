...
| Pipeline orchestration | `hypnodata/pipeline.py` | Per-record execution, dry-run/crash behavior, QC/failure accounting, progress writes | Keep orchestration here and signal math in `preprocess.py` |
