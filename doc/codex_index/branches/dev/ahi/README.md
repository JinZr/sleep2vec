# `dev/ahi` Codex Engineering Index

This directory is the branch-scoped engineering manual for `dev/ahi`. It is intended to be consulted before editing code in this repository.
