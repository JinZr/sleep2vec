...
| Runtime utilities | `sleep2vec/checkpoints.py`, `sleep2vec/metrics.py`, `sleep2vec/diagnostics.py`, `sleep2vec/callbacks/`, `sleep2vec/visualization/` | Checkpoint averaging, metrics, diagnostics hooks, runtime callbacks, visualization artifacts | Torch, sklearn, wandb, matplotlib | New logging/export surfaces | `ahi` pointwise-train metrics and final event-based evaluation both live here; keep task-specific math and callback behavior centralized |
