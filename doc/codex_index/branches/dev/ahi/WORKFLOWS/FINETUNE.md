...
- Multi-device built-in `ahi` finetune disables Lightning's built-in progress bar because the progress callback only runs on global zero and can otherwise delay epoch-end hook ordering relative to the other ranks.
