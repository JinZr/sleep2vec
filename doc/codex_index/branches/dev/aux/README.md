# `dev/aux` Codex Engineering Index

This directory is the branch-scoped engineering manual for `dev/aux`. It is intended to be consulted before editing code in this repository.

## Branch Scope

- Branch: `dev/aux`
- Commit: `99d22deee69cc3cb9eae9229a8faaa4c33974824`
- Generated at: `2026-04-20T10:01:10Z`
- Mode: `initialize-branch`
- Main baseline: `99d22deee69cc3cb9eae9229a8faaa4c33974824` (`dev/aux` currently diverges from `main` through working-tree edits only)
...
Current code indexed from this branch working tree:
...
- Every claim in this index is grounded in the current working tree on `dev/aux` and compared against `main` only for cross-branch delta reporting.
...
- Runtime execution was only partially rerun during this implementation update; verification evidence comes from source inspection, `compileall`, and targeted config checks.
