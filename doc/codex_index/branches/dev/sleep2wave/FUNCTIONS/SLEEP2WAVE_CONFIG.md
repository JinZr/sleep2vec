...
- Dataclasses:
  ...
  - `ReplayConfig`, `CorruptionChoiceConfig`, `CorruptionSpecConfig`, `CorruptionPolicyConfig`, `TrainingCorruptionsConfig`, `TrainingValidationConfig`, `ValidationExamplesConfig`, `TrainingConfig`, `InferenceConfig`, `SamplerConfig`
...
- Functions:
  ...
  - `_load_training(raw, configured_modalities) -> TrainingConfig`
