...
| Generation runtime | `run_generation` | Owns task creation, inference corruption overrides, checkpoint loading, window collection, fusion, uncertainty, and artifact export | Separate generation scripts |
