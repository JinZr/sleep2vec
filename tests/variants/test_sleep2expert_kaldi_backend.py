...
def test_sleep2expert_kaldi_dataset_accepts_hidden_size_channel_specs(tmp_path: Path) -> None:
    from sleep2expert.data.kaldi_psg_dataset import KaldiPSGDataset
...
def test_sleep2expert_converter_reads_yaml_channel_alias(tmp_path: Path):
...
def test_sleep2expert_converter_split_filter_selects_requested_split(tmp_path: Path):
    _require_kaldi_native_io()
    from sleep2expert.preprocess.convert_npz_to_kaldi import convert, parse_args
