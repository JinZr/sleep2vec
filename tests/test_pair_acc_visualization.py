...
def test_render_pair_acc_heatmap_uses_tilted_x_labels():
...
def test_render_sleep2expert_pair_acc_heatmap_uses_tilted_x_labels():
    matrix = np.zeros((3, 3), dtype=np.float32)
...
@pytest.mark.parametrize("render_heatmap", [render_pair_acc_heatmap, render_sleep2expert_pair_acc_heatmap])
