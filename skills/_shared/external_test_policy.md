...
Hyper-parameter search selects on validation only. External test evaluation is a separate explicit final step and must not happen during run generation.
