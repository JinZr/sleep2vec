...
from sleep2vec_hires.config import AdaptConfig
from sleep2vec_hires.data.channel_selection import build_all_pairs
...
class Sleep2vecAdaptation(Sleep2vecPretraining):
