...
from sleep2vec_hires.checkpoints import average_checkpoints, select_checkpoints
from sleep2vec_hires.common import apply_finetune_config
from sleep2vec_hires.distributed import is_rank_zero_process
from sleep2vec_hires.results import (
    prepare_inference_result_paths,
    save_inference_manifest,
    save_prediction_csv,
    save_result_csv,
)
from sleep2vec_hires.sleep2vec_finetuning import Sleep2vecFinetuning
from sleep2vec_hires.utils import _build_finetune_loader
...
def run_inference(args):
    ...
    prepare_inference_result_paths(args, namespace="sleep2vec_hires", checkpoint_paths=selected_ckpt_paths)
