...
from sleep2vec_hires.checkpoints import get_state_dict_from_checkpoint, load_checkpoint
from sleep2vec_hires.common import apply_data_backend_args, apply_model_config_args
from sleep2vec_hires.config import load_finetune_config, load_pretrain_config
from sleep2vec_hires.data.kaldi_psg_dataset import KaldiPSGDataset
from sleep2vec_hires.data.psg_pretrain_dataset import PSGPretrainDataset
from sleep2vec_hires.preprocess.save_dataset_presets import (
    _load_preset_build_block,
    _resolve_effective_min_channels,
    _resolve_validation_channels,
)
from sleep2vec_hires.pretrain_model import Sleep2vecPretrainModel
from sleep2vec_hires.utils import move_to_device

PACKAGE_NAMESPACE = "sleep2vec_hires"
...
def _apply_finetune_adapters(
    ...
    from sleep2vec_hires.downstream_model import Sleep2vecDownstreamModel
