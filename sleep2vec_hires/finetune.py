...
from sleep2vec_hires.callbacks import build_distributed_ahi_progress_bar
from sleep2vec_hires.common import apply_finetune_config, persist_run_config_and_args
from sleep2vec_hires.results import save_result_csv
from sleep2vec_hires.sleep2vec_finetuning import Sleep2vecFinetuning
from sleep2vec_hires.utils import get_finetune_dataloaders
...
def supervised(args, config_bundle):
    ...
    logger = WandbLogger(
        project="sleep2vec_hires-finetune",  # 相当于 TensorBoard 的 log dir
        name=f"sleep2vec_hires-finetune-{version}",  # run 名称
