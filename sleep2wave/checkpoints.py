...
def load_pretrain_init_weights(
    ...
    *,
    ...
    if target_uses_standalone_roformer and legacy_roformer_keys:
        ...
        raise ValueError(
            "sleep2wave does not support loading legacy sleep2vec/HF RoFormer checkpoints into the standalone "
            f"RoFormer backbone. Train or convert a sleep2wave checkpoint instead. Legacy keys: {preview}"
        )
