...
from sleep2wave.callbacks import build_distributed_ahi_progress_bar
from sleep2wave.common import apply_finetune_config, persist_run_config_and_args
from sleep2wave.results import save_result_csv
from sleep2wave.sleep2vec_finetuning import Sleep2vecFinetuning
from sleep2wave.utils import get_finetune_dataloaders
...
def supervised(args, config_bundle):
    ...
    logger = WandbLogger(
        project="sleep2wave-finetune",  # 相当于 TensorBoard 的 log dir
        name=f"sleep2wave-finetune-{version}",  # run 名称
