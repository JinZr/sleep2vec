...
from wrist2vec_flex.checkpoints import average_checkpoints, select_checkpoints
from wrist2vec_flex.common import apply_finetune_config
from wrist2vec_flex.distributed import is_rank_zero_process
...
def _init_wandb(args):
    ...
    init_kwargs = {
        "project": args.wandb_project or "wrist2vec-flex-infer",
