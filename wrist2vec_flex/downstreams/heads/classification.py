...
from wrist2vec_flex.downstreams.head_registry import register_head
...
class ClassificationHead(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.fusion = FeatureFusion(feature_dim, n_mods, agg, agg_kwargs=agg_kwargs)
    ...
    def forward(
        ...
        *,
        ...
        fused, has_L = self.fusion.aggregator(feature_of_different_mods, channel_mask=channel_mask)
        if has_L:
            B, L, E = fused.shape
