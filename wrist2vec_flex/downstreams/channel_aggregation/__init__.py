...
from .learned_query import LearnedQueryChannelAggregator
from .mean import MeanChannelAggregator

_REGISTRY = {
    MeanChannelAggregator.name: MeanChannelAggregator,
    "masked_mean": MeanChannelAggregator,
    ConcatChannelAggregator.name: ConcatChannelAggregator,
    GatedScalarChannelAggregator.name: GatedScalarChannelAggregator,
    "masked_gated_scalar": GatedScalarChannelAggregator,
    LearnedQueryChannelAggregator.name: LearnedQueryChannelAggregator,
}
