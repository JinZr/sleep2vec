...
def wrist2vec_pretrain(args):
    ...
    if args.ckpt_path is not None and os.path.isfile(args.ckpt_path):  # NEW
        ...
        save_path = f"log-wrist2vec-pretrain/{run_name}/checkpoints"
    ...
    logger = WandbLogger(
        project="wrist2vec-pretrain",
        name=f"w2v-pretrain-{run_name}",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="",
        help=(
            "Extra tag inserted into log-wrist2vec-pretrain/<run_name>; useful for noting "
